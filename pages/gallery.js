                ...
                <section className="py-16 text-center bg-white shadow-sm">
                    ...
                    <div className="mt-8 flex justify-center gap-4">
                        <button
                            ...
                            className={`px-6 py-2 rounded-full font-medium transition ${activeTab === "social" ? "bg-saffron text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}
                        >
                            Social
                        </button>
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-full font-medium transition ${activeTab === "programmes" ? "bg-saffron text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}
                        >
                            Programmes
                        </button>
                    </div>
